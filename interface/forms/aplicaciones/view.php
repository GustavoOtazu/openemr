...
<head>
    ...
    <title><?php echo xlt('Nursing Applications'); ?></title>
    <link rel="stylesheet" href="<?php echo $css_header; ?>" type="text/css">
    <style>
        .aplicaciones-view * { margin: 0; padding: 0; box-sizing: border-box; }
        body {
        ...
        .aplicacion-detalle { background-color: white; border: 1px solid #dee2e6; border-radius: 3px; margin-bottom: 12px; overflow: hidden; }
        .aplicacion-header  { display: flex; justify-content: space-between; align-items: center; padding: 12px 15px; background-color: #f8f9fa; }
        .aplicacion-header.si { background-color: #d4edda; border-left: 4px solid #28a745; }
        .aplicacion-header.no { background-color: #f8f9fa; border-left: 4px solid #6c757d; }
        .aplicacion-nombre  { font-size: 14px; font-weight: 600; color: #333; }
        ...
        .aplicacion-obs { padding: 18px 20px; background-color: #f8f9fa; }
        .aplicacion-obs.con-contenido { background: linear-gradient(135deg, #e7f3ff 0%, #cfe2ff 100%); border-top: 3px solid #0d6efd; }
        .aplicacion-obs h5 { font-size: 12px; color: #6c757d; margin-bottom: 10px; text-transform: uppercase; letter-spacing: 1px; font-weight: 700; }
        .aplicacion-obs p  { font-size: 14px; color: #212529; line-height: 1.7; white-space: pre-wrap; }
...
<body>
<div class="aplicaciones-view container">
    <h2><?php echo $id > 0 ? xlt('Application Detail') : xlt('Application List'); ?></h2>
    ...
    <div class="registro-card">
        <div class="registro-header">
            ...
            <div class="registro-acciones">
                <a href="<?php echo attr($GLOBALS['webroot'] . '/interface/forms/aplicaciones/new.php?pid=' . $pid . '&encounter=' . $encounter . '&id=' . $row['id']); ?>"
                   class="btn-accion btn-editar">
                    <?php echo xlt('Edit'); ?>
                </a>
                <a href="<?php echo attr($GLOBALS['webroot'] . '/interface/forms/aplicaciones/print.php?pid=' . $pid . '&encounter=' . $encounter . '&id=' . $row['id']); ?>"
        ...
        <div class="aplicacion-detalle">
            ...
            <div class="aplicacion-obs <?php echo !empty($obs) ? 'con-contenido' : ''; ?>">
