    ...
    <div class="row">
        <div class="col-sm-12">
            <form id="new-encounter-form" method='post' action="<?php echo $rootdir ?>/forms/newpatient/save.php" name='new_encounter'>
                ...
                <fieldset>
                    ...
                    <div id = "visit-details">
                        <div class="form-group ">
                            <label for="pc_catid" class="control-label col-sm-2 oe-text-to-right"><?php echo xlt('Categorías:'); ?></label>
                            <div class="col-sm-3">
                                <select  name='pc_catid' id='pc_catid' class='form-control col-sm-12'>
                                    <option value='_blank'>-- <?php echo xlt('Seleccione uno'); ?> --</option>
                                    <?php
                                    //Bring only patient ang group categories
                                    $visitSQL = "SELECT pc_catid, pc_catname, pc_cattype
                                                       FROM openemr_postcalendar_categories
                                                       WHERE pc_active = 1 and pc_cattype IN (0,3) and pc_constant_id  != 'no_show' ORDER BY pc_catid DESC";
                                    ...
                                    while ($row = sqlFetchArray($visitResult)) {
                                        ...
                                        $optionStr = '<option value="%pc_catid%" %selected% data-name="%pc_catname%">%pc_catname%</option>';
                        ...
                        <div class="form-group internacion">
                            ...
                            <div class="col-sm-8">
                                <select class="form-control col-sm-9" name="departamento" id="departamento">
                                    <option value="terapia_adulto">Terapia adulto</option>
                                    <option value="terapia_kids">Terapia niños</option>
                                </select>
                            </div>
                            <div class="clearfix"></div>
                        </div>
                        <br>
                        <div class="form-group internacion">
                            <label class="control-label col-sm-2 oe-text-to-right" id="servicio">Servicio</label>
                            <div class="col-sm-8">
                        ...
                        <br>
                        <div class="form-group internacion">
                            <label class="control-label col-sm-2 oe-text-to-right" id="cama">Cama</label>
                            <div class="col-sm-8">
                ...
                <fieldset>
                    <legend><?php echo xlt('Razón de la visita')?></legend>
                    <div class="form-group">
